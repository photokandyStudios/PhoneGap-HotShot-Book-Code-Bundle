...
APP.init = function()
{
  ...
  // english
  PKLOC.addTranslation("en", "APP_TITLE", "Mem'ry");
  PKLOC.addTranslation("en", "APP_TITLE_IMG", "<img src='./images/Title.png' width=87 height=31 />");
  ...
  APP.globalFileExtension = ".3gp|.mp4|.mov|.MOV|.3GP|.MP4.|.m4v|.M4V";

  // initialize our application
  PKUI.CORE.initializeApplication();

  PKUTIL.loadHTML("./views/movieView.html",
  {
    id : "movieView",
    className : "container",
